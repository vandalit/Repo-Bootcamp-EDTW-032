...
La [clase `Array`](http://www.ruby-doc.org/core-2.5.3/Array.html) es una de las estructuras principales para resguardar y acceder a información en Ruby (la otra es [Hash](http://www.ruby-doc.org/core-2.5.3/Hash.html)).
